...
namespace FSH.NewId.NewIdFormatters
{
    internal static class IntrinsicsHelper
    {
        ...
        public static void Vector256ToCharUtf16(Vector256<byte> vec, Span<byte> destination)
        {
            ...
            var c0   = Avx2.UnpackLow(vec, zero);
            var c1   = Avx2.UnpackHigh(vec, zero);

            var t0 = Avx2.Permute2x128(c0, c1, 0b_10_00_00);
            var t1 = Avx2.Permute2x128(c0, c1, 0b_11_00_01);
        ...
        {
            var shuffled = Avx2.Shuffle(value, Vector256.Create(0, 2, 4, 6, 8, 10, 12, 14, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0, 2, 4, 6, 8, 10, 12, 14));
        ...
        {
            var lowerCharSet = Vector256.Create((byte)'0', (byte)'1', (byte)'2', (byte)'3', (byte)'4', (byte)'5', (byte)'6', (byte)'7', (byte)'8', (byte)'9', (byte)'a', (byte)'b', (byte)'c', (byte)'d', (byte)'e', (byte)'f', (byte)'0', (byte)'1', (byte)'2',
                                                (byte)'3', (byte)'4', (byte)'5', (byte)'6', (byte)'7', (byte)'8', (byte)'9', (byte)'a', (byte)'b', (byte)'c', (byte)'d', (byte)'e', (byte)'f');

            var upperCharSet = Vector256.Create((byte)'0', (byte)'1', (byte)'2', (byte)'3', (byte)'4', (byte)'5', (byte)'6', (byte)'7', (byte)'8', (byte)'9', (byte)'A', (byte)'B', (byte)'C', (byte)'D', (byte)'E', (byte)'F', (byte)'0', (byte)'1', (byte)'2',
                                                (byte)'3', (byte)'4', (byte)'5', (byte)'6', (byte)'7', (byte)'8', (byte)'9', (byte)'A', (byte)'B', (byte)'C', (byte)'D', (byte)'E', (byte)'F');
